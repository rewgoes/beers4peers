        ...
        try {
            ...
            if(inputLine != null){
                if (inputLine.equals("client")){
                    ...
                    if (outputLine == null)
                        ;// TODO: Undo all ations taken, and maybe change addClient() function, in case of error
                    else{
                        ...
                        if(inputLine != null)
                            if (inputLine.equals("OK"))
                                //Success
                                System.out.println("Control: Client " + socket.getInetAddress() + ":" +
                                        socket.getPort() + " added to " + outputLine);
                            else{
                                System.err.println("Error: Could not add client");
                    ...
                    synchronized(this){
                        addSupernode();
                        ;// TODO: Undo all ations taken, and maybe change addSupernode() function, in case of error
                    }
                    ...
                    //Success
                    System.out.println("Control: Supernode " + socket.getInetAddress() + ":" +
